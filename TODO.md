...
6. ~~**Clienti esteri azienda o privato**~~ fatto il 24/09/2026 (servizi elettronici a privati UE, art. 7-octies, **da verificare**) —: UE privato → N2.2 senza "inversione contabile", INVCONT né Intrastat (art. 7-ter c. 1 lett. b); extra UE privato → N2.1 solo per i servizi dell'art. 7-septies.
